...
export const ENEMIES = {
  goblin: {
    ...
    attackBonus: 4, damageDice: '1d6', damageMod: 2, attacksPerTurn: 1,
    initiativeMod: 2,
  ...
  bugbear: {
    ...
    attackBonus: 4, damageDice: '2d8', damageMod: 2, attacksPerTurn: 1,
    initiativeMod: 2,
  ...
  wolf: {
    ...
    attackBonus: 4, damageDice: '2d4', damageMod: 2, attacksPerTurn: 1,
    initiativeMod: 2,
  ...
  zombie: {
    ...
    attackBonus: 3, damageDice: '1d6', damageMod: 1, attacksPerTurn: 1,
    initiativeMod: -2,
  ...
  nothic: {
    ...
    attackBonus: 4, damageDice: '1d6', damageMod: 2, attacksPerTurn: 2,
    initiativeMod: 3,
